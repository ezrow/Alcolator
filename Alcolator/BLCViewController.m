...
- (void)viewDidLoad
{
    ...
    self.beerPercentTextField.font = [UIFont systemFontOfSize:15];
    self.beerPercentTextField.autocorrectionType = UITextAutocorrectionTypeNo;
    self.beerPercentTextField.keyboardType = UIKeyboardTypeDefault;
    self.beerPercentTextField.returnKeyType = UIReturnKeyDone;
    self.beerPercentTextField.clearButtonMode = UITextFieldViewModeWhileEditing;
    self.beerPercentTextField.contentVerticalAlignment = UIControlContentVerticalAlignmentCenter;
    self.beerPercentTextField.textColor = [UIColor colorWithRed:0.2f green:0.2f blue:0.2f alpha:0.50001f];
...
- (void) viewWillLayoutSubviews {
    ...
    self.beerPercentTextField.frame = CGRectMake(padding, start, itemWidth, itemHeight);
